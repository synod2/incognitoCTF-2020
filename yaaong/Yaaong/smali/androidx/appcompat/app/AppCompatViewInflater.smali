...
.method public final a(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    sget p6, La/a/j;->View_android_theme:I
    ...
    instance-of p7, p1, La/a/n/c;

    if-eqz p7, :cond_4

    move-object p7, p1

    check-cast p7, La/a/n/c;

    .line 2
    iget p7, p7, La/a/n/c;->a:I

    if-eq p7, p6, :cond_5

    .line 3
    :cond_4
    new-instance p7, La/a/n/c;

    invoke-direct {p7, p1, p6}, La/a/n/c;-><init>(Landroid/content/Context;I)V
    ...
    .line 5
    :pswitch_0
    new-instance p6, La/a/o/t;

    invoke-direct {p6, p1, p4}, La/a/o/t;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto :goto_4

    .line 6
    :pswitch_1
    new-instance p6, La/a/o/s;

    invoke-direct {p6, p1, p4}, La/a/o/s;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto :goto_4

    .line 7
    :pswitch_2
    new-instance p6, La/a/o/o;

    invoke-direct {p6, p1, p4}, La/a/o/o;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto :goto_4

    .line 8
    :pswitch_3
    new-instance p6, La/a/o/d;

    invoke-direct {p6, p1, p4}, La/a/o/d;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto :goto_4

    .line 9
    :pswitch_4
    new-instance p6, La/a/o/h;

    invoke-direct {p6, p1, p4}, La/a/o/h;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto :goto_4

    .line 10
    :pswitch_5
    new-instance p6, La/a/o/r;

    invoke-direct {p6, p1, p4}, La/a/o/r;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto :goto_4

    .line 11
    :pswitch_6
    new-instance p6, La/a/o/g;

    invoke-direct {p6, p1, p4}, La/a/o/g;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto :goto_4

    .line 12
    :pswitch_7
    new-instance p6, La/a/o/l;

    .line 13
    sget v1, La/a/a;->imageButtonStyle:I

    invoke-direct {p6, p1, p4, v1}, La/a/o/l;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    goto :goto_4

    .line 14
    :pswitch_8
    new-instance p6, La/a/o/w;

    .line 15
    sget v1, La/a/a;->spinnerStyle:I

    invoke-direct {p6, p1, p4, v1}, La/a/o/w;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    goto :goto_4

    .line 16
    :pswitch_9
    new-instance p6, La/a/o/k;

    invoke-direct {p6, p1, p4}, La/a/o/k;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto :goto_4

    .line 17
    :pswitch_a
    new-instance p6, La/a/o/f;

    invoke-direct {p6, p1, p4}, La/a/o/f;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto :goto_4

    .line 18
    :pswitch_b
    new-instance p6, La/a/o/n;

    invoke-direct {p6, p1, p4}, La/a/o/n;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    goto :goto_4

    .line 19
    :pswitch_c
    new-instance p6, La/a/o/y;

    invoke-direct {p6, p1, p4}, La/a/o/y;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p6}, La/e/k/m;->g(Landroid/view/View;)Z
